...
/*const menorq = crazyNumbers.reduce((accumulator, crazyNumbers)=>{
  if(crazyNumbers < 501){
    accumulator +=1
  }
  return accumulator
...
const countmenorq501 = (accumulator, crazyNumber) => 
crazyNumber < 501 ? ++accumulator : accumulator

const menorq501 = crazyNumbers.reduce(countmenorq501, 0)
 
console.log(menorq501)
...
const resultado = numbers.map(item => item **2)
...
const menorAno = tarantinoMovies.filter(({release})=> release< 2000);
